...
{   
    ...
    if(myPlayerObject){
        if(gameObject.name == "Model1Grey(Clone)"){
            Instantiate(Beamsmodel1,transform.position + new Vector3(0,-7.52f,0),Quaternion.identity);
            audioShoot.Play();
        }else if(gameObject.name == "Model1Red(Clone)"){
            Instantiate(Beamsmodel1,transform.position + new Vector3(0,-7.52f,0),Quaternion.identity);
            audioShoot.Play();
        }else if(gameObject.name == "Model2_Grey(Clone)" ){
            Instantiate(Beamsmodel2,transform.position + new Vector3(0,-7.52f,0),Quaternion.identity);
            audioShoot.Play();
        }else if( gameObject.name == "Model2_Red(Clone)"){
            Instantiate(Beamsmodel2,transform.position + new Vector3(0,-7.52f,0),Quaternion.identity);
            audioShoot.Play();
        }else if(gameObject.name == "Model3Grey(Clone)" ){
            Instantiate(Beamsmodel3,transform.position + new Vector3(0,-7.52f,0),Quaternion.identity);
            audioShoot.Play();
        }else if( gameObject.name == "Model3Red(Clone)"){
            Instantiate(Beamsmodel3,transform.position + new Vector3(0,-7.52f,0),Quaternion.identity);
            audioShoot.Play();    
        }else if(gameObject.name == "Model4Red(Clone)"){
            Instantiate(Beamsmodel4,transform.position + new Vector3(0,-7.52f,0),Quaternion.identity);
            audioShoot.Play();
